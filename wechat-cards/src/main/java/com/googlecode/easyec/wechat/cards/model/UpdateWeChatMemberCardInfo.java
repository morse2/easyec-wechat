...
/**
 * 微信修改卡券管理中会员卡的基本信息和高级信息的对象类
 */
@JsonInclude(NON_EMPTY)
@JsonIgnoreProperties(ignoreUnknown = true
)
public class UpdateWeChatMemberCardInfo extends AbstractUpdateWeChatCardInfo {


    private static final long serialVersionUID = -2295466476950537562L;
    ...
    public UpdateWeChatMemberCardInfo() {
        super(new UpdateMemberWeChatMemberCardBaseInfo());
    }
