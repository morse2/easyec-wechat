...
import com.googlecode.easyec.wechat.cards.model.DecryptCode;
import com.googlecode.easyec.wechat.cards.model.DecryptCodeResult;
 ...
 * 核销卡券的请求处理类
 */
public class DecryptCodeRequestHandler extends AbstractWeChatHttpPostRequestHandler<DecryptCodeResult, DecryptCode> {

    public DecryptCodeRequestHandler(StreamObjectFactory objectFactory, String baseUri, DecryptCode bean) {
